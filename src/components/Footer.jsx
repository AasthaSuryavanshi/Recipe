...
const Footer = () => {
  return (
    ...
    <div className='Footer'>
      <div className="w-[80%] m-auto  p-10 mt-[10vh] bg-[#FCFEFF]">
            <h2 className="text-green-600 font-semibold text-center">Features</h2>
            <h1 className="text-2xl font-bold text-center text-[4vh] text-indigo-900">
            ...
            <div className="features flex flex-wrap justify-between mt-[5%]">
                ...
                <div className="w-[40%] flex items-center">
                    ...
                    <div className="">
                        <h1 className="text-xl">Cook like a Cheif</h1>
                        <p className="text-sm text-zinc-400">
                            Lorem ipsum dolor, sit amet consectetur adipisicing
                            elit. Deleniti nesciunt sit in? Consectetur, illum
                            ipsum!
